        ...
        <div className="bg-black  rounded-[1.64rem]  lg:rounded-[2.778rem] flex flex-col justify-between">
          <div className="pl-[2.51rem] pt-[2.57rem] pr-[3.46rem] ">
            ...
            <h2 className="text-[#FFF1E1] pb-[2.52rem] text-[1.03rem] lg:text-[1.556rem]">
              Founded on the principles of inclusivity, health, and
              connectivity. We are a movement towards creating a more engaged,
              healthy, and united community. We excel in orchestrating diverse
              sports and gathering events, all geared to bring people together,
              breaking down barriers and creating platforms for mutual
